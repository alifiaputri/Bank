                ...
                if (pin==1234)//cek pin
                    do{
                        ...
                        case 1:
                            ...
                            z=JOptionPane.showConfirmDialog(null,"Melanjutkan transaksi lain?","ATM BNI SYARIAH",
                            JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain
                                if (z==0)
                                break;
                                else

                            JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM BNI SYARIAH, ambil kartu ATM Anda.");
